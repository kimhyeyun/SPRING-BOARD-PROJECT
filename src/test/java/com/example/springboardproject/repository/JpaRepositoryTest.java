...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newYun", "pw", null, null, null));
    ...
    void givenArticleCommentIdHavingChildCommentsAndUserId_whenDeletingParentComment_thenDeletesEveryComment() {
        ...
        // When
        articleCommentRepository.deleteByIdAndUserAccount_UserId(1L, "yun");
    ...
    @Test
    void givenHashtagNamesAndPageable_when_QueryingArticles_thenReturnsArticlePage() {
        // Given
